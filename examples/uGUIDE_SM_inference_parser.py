...
parser.add_argument('--x_train', type=str, default=None, help='Training data.')
parser.add_argument('--theta_train',
                    type=str,
                    default=None,
                    help='Training data.')
parser.add_argument('--x_test', type=str, help='Testing data.')
parser.add_argument('--theta_test', type=str, help='Testing data.')
...
for p, param in enumerate(config['prior'].keys()):
    ...
    plt.plot(theta_test[:nb_theta, p],
             theta_test[:nb_theta, p],
             c='k',
             alpha=0.5)
